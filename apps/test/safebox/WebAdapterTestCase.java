...
@SpringBootTest(classes = MowerBackendApplication.class)
@AutoConfigureMockMvc
public abstract class WebAdapterTestCase {
    ...
    protected void assertRequestWithBody(String method, String endpoint, String body,
        ...
        mockMvc.perform(request(HttpMethod.valueOf(method), endpoint).content(body).contentType(APPLICATION_JSON))
                .andExpect(status().is(expectedStatusCode)).andExpect(content().string(""));
    }
}
