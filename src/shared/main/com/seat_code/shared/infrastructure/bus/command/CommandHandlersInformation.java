package com.seat_code.shared.infrastructure.bus.command;
...
import com.seat_code.shared.domain.bus.command.CommandNotRegisteredError;
...
public final class CommandHandlersInformation {
    ...
    public CommandHandlersInformation() {
        Reflections reflections = new Reflections("com.seat_code");
