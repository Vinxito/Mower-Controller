package com.seat.shared.infrastructure.bus.command;
...
import com.seat.shared.domain.bus.command.CommandNotRegisteredError;
...
public final class CommandHandlersInformation {
    ...
    public CommandHandlersInformation() {
        Reflections reflections = new Reflections("com.seat");
