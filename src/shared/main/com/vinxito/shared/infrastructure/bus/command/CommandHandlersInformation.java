package com.vinxito.shared.infrastructure.bus.command;
...
import com.vinxito.shared.domain.bus.command.CommandNotRegisteredError;
...
public final class CommandHandlersInformation {
    ...
    public CommandHandlersInformation() {
        Reflections reflections = new Reflections("com.vinxito");
